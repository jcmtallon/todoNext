module.exports = {
  ...
  form : {
    body_wrapper: 'form_body-wrapper',
    body_row: 'form_body-row',
  },
  ...
  field : {
    ...
    label: 'field_label',
    multichoice: 'field_multichoice',
    date_field_validDate: 'field_date-field--valid-date',
    field_validInput: 'field_field--valid',
  },
