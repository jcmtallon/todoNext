...
class Icons{
  ...
  number1(col){
    ...
    let color = (col!= undefined) ? col : activeBlue;
  ...
  info(color){
    ...
    let icon = $(document.createElementNS('http://www.w3.org/2000/svg', 'svg'));
    icon.attr({viewBox:'0 0 330 330'});

    let path1 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path1.attr({d:"M165,0C74.019,0,0,74.02,0,165.001C0,255.982,74.019,330,165,330s165-74.018,165-164.999C330,74.02,255.981,0,165,0zM165,300c-74.44,0-135-60.56-135-134.999C30,90.562,90.56,30,165,30s135,60.562,135,135.001C300,239.44,239.439,300,165,300z"});
    path1.attr({fill:color});

    let path2 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path2.attr({d:"M164.998,70c-11.026,0-19.996,8.976-19.996,20.009c0,11.023,8.97,19.991,19.996,19.991c11.026,0,19.996-8.968,19.996-19.991C184.994,78.976,176.024,70,164.998,70z"});
    path2.attr({fill:color});

    let path3 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path3.attr({d:"M165,140c-8.284,0-15,6.716-15,15v90c0,8.284,6.716,15,15,15c8.284,0,15-6.716,15-15v-90C180,146.716,173.284,140,165,140z"});
    path3.attr({fill:color});
  ...
  checkbox(color){
    ...
    let icon = $(document.createElementNS('http://www.w3.org/2000/svg', 'svg'));
    icon.attr({viewBox:'0 0 52 52'});

    let path1 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path1.attr({d:"M26,0C11.664,0,0,11.663,0,26s11.664,26,26,26s26-11.663,26-26S40.336,0,26,0z M26,50C12.767,50,2,39.233,2,26S12.767,2,26,2s24,10.767,24,24S39.233,50,26,50z"});
    path1.attr({fill:color});

    let path2 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path2.attr({d:"M38.252,15.336l-15.369,17.29l-9.259-7.407c-0.43-0.345-1.061-0.274-1.405,0.156c-0.345,0.432-0.275,1.061,0.156,1.406l10,8C22.559,34.928,22.78,35,23,35c0.276,0,0.551-0.114,0.748-0.336l16-18c0.367-0.412,0.33-1.045-0.083-1.411C39.251,14.885,38.62,14.922,38.252,15.336z"});
    path2.attr({fill:color});
  ...
  activate(color){
    ...
    let path1 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path1.attr({d:"M288.502,32.502c-108.328,0-198.827,77.485-219.166,179.899l-42.482-53.107L0,180.784l68.769,85.961c3.352,4.178,8.338,6.447,13.427,6.447c2.596,0,5.226-0.585,7.685-1.805l103.153-51.577l-15.387-30.757l-75.8,37.892c14.063-90.5,92.27-160.059,186.655-160.059c104.271,0,189.114,84.843,189.114,189.114s-84.843,189.114-189.114,189.114v34.384C411.735,479.498,512,379.233,512,256S411.735,32.502,288.502,32.502z"});
    path1.attr({fill:color});
  ...
  stop(col){
    ...
    let path1 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path1.attr({d:"M106,121.083c-2.135-2.135-5.01-3.24-8.104-3.115c-3.021,0.167-5.823,1.594-7.729,3.948c-30.635,37.844-47.5,85.458-47.5,134.083c0,117.635,95.698,213.333,213.333,213.333c48.625,0,96.24-16.865,134.083-47.5c2.354-1.906,3.781-4.708,3.948-7.729c0.156-3.021-0.979-5.969-3.115-8.104L106,121.083z M256,448c-105.865,0-192-86.135-192-192c0-40.406,12.25-78.604,35.542-111.198l267.656,267.656C334.604,435.75,296.406,448,256,448z"});
    path1.attr({fill:color});

    let path2 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path2.attr({d:"M256,0C114.844,0,0,114.844,0,256s114.844,256,256,256s256-114.844,256-256S397.156,0,256,0z M256,490.667C126.604,490.667,21.333,385.396,21.333,256S126.604,21.333,256,21.333S490.667,126.604,490.667,256S385.396,490.667,256,490.667z"});
    path2.attr({fill:color});

    let path3 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path3.attr({d:"M256,42.667c-48.625,0-96.24,16.865-134.083,47.5c-2.354,1.906-3.781,4.708-3.948,7.729c-0.156,3.021,0.979,5.969,3.115,8.104L406,390.917c2,2.01,4.719,3.125,7.542,3.125c0.188,0,0.375,0,0.563-0.01c3.021-0.167,5.823-1.594,7.729-3.948c30.635-37.844,47.5-85.458,47.5-134.083C469.333,138.365,373.635,42.667,256,42.667zM412.458,367.198L144.802,99.542C177.396,76.25,215.594,64,256,64c105.865,0,192,86.135,192,192C448,296.406,435.75,334.604,412.458,367.198z"});
    path3.attr({fill:color});
  ...
  play(col){
    ...
    let path1 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path1.attr({d:"M45.563,29.174l-22-15c-0.307-0.208-0.703-0.231-1.031-0.058C22.205,14.289,22,14.629,22,15v30c0,0.371,0.205,0.711,0.533,0.884C22.679,45.962,22.84,46,23,46c0.197,0,0.394-0.059,0.563-0.174l22-15C45.836,30.64,46,30.331,46,30S45.836,29.36,45.563,29.174z M24,43.107V16.893L43.225,30L24,43.107z"});
    path1.attr({fill:color});

    let path2 = $(document.createElementNS('http://www.w3.org/2000/svg', 'path'));
    path2.attr({d:"M30,0C13.458,0,0,13.458,0,30s13.458,30,30,30s30-13.458,30-30S46.542,0,30,0z M30,58C14.561,58,2,45.439,2,30S14.561,2,30,2s28,12.561,28,28S45.439,58,30,58z"});
    path2.attr({fill:color});
